...
datafiles <- dir(path = "data/Superior_Files", pattern="Superior.*csv", full.names = TRUE)
...
All.Samples <- subset(summaryfile, select = c(subSampleID,
                                              ...
                                              organismCount,
                                              length))
write.csv(All.Samples, "data/Superior_Files/Summaries/All.Samples.csv", row.names=FALSE)
